...
import static net.p3pp3rf1y.sophisticatedcore.client.gui.controls.ButtonDefinitions.*;
...
public class SBPButtonDefinitions {
	public static final ButtonDefinition.Toggle<ContentsFilterType> BACKPACK_CONTENTS_FILTER_TYPE = createToggleButtonDefinition(
			Map.of(ContentsFilterType.ALLOW,
					getButtonStateData(new UV(0, 0), SBPTranslationHelper.INSTANCE.translUpgradeButton("allow"), Dimension.SQUARE_16, new Position(1, 1)),
					ContentsFilterType.BLOCK,
					getButtonStateData(new UV(16, 0), SBPTranslationHelper.INSTANCE.translUpgradeButton("block"), Dimension.SQUARE_16, new Position(1, 1)),
					ContentsFilterType.STORAGE, getButtonStateData(new UV(80, 16), SBPTranslationHelper.INSTANCE.translUpgradeButton("match_backpack_contents"),
							Dimension.SQUARE_16, new Position(1, 1))));

	private SBPButtonDefinitions() {
	}

	public static final ButtonDefinition.Toggle<Boolean> SHIFT_CLICK_TARGET = createToggleButtonDefinition(Map.of(true,
	...
	public static final ButtonDefinition.Toggle<Boolean> REFILL_CRAFTING_GRID = createToggleButtonDefinition(Map.of(true,
	...
	public static final ButtonDefinition.Toggle<Boolean> REFILL_INPUT = createToggleButtonDefinition(Map.of(true,
