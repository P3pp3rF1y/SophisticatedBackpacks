...
public class ClientLinkedStorageTooltip implements ClientTooltipComponent {
	...
	public static void renderRole(Font font, int x, int y, GuiGraphicsExtractor guiGraphics, LinkedStorageEndpointRole role, @Nullable UUID groupId) {
		LinkedStorageEndpointRoleRenderer.renderIcon(guiGraphics, x - 2, y, role);
		guiGraphics.text(font, getDescription(role, groupId), x + 16, y + 4, ROLE_TEXT_COLOR);
	}
