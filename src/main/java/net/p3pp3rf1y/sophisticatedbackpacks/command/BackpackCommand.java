...
public class BackpackCommand {
	...
	private static final Supplier<SingletonArgumentInfo<BackpackUUIDArgumentType>> BACKPACK_UUID_COMMAND_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES.register(
			"backpack_uuid",
	...
	private static final Supplier<SingletonArgumentInfo<BackpackPlayerArgumentType>> PLAYER_NAME_COMMAND_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES
	...
	private static final Supplier<SingletonArgumentInfo<BackpackTemplateArgumentType>> TEMPLATE_NAME_COMMAND_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES
	...
	private static final Supplier<SingletonArgumentInfo<BackpackItemArgumentType>> BACKPACK_ITEM_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES.register(
			"backpack_item",
	...
	private static final Supplier<SingletonArgumentInfo<BackpackUpgradeItemArgumentType>> BACKPACK_UPGRADE_ITEM_ARGUMENT_TYPE = COMMAND_ARGUMENT_TYPES
	...
	private static void registerCommands(RegisterCommandsEvent event) {
		...
		LiteralCommandNode<CommandSourceStack> mainNode = dispatcher.register(Commands.literal("sb").requires(cs -> cs.hasPermission(OP_LEVEL))
