...
/* TODO readd with new version of curios
			BackpackLayerRenderer.submitBackpack(renderLayerParent.getModel(), poseStack, renderTypeBuffer, packedLight, stack, !slotContext.entity().getItemBySlot(equipmentSlot).isEmpty(), BackpackModelManager.getBackpackModel(stack.getItem()), renderState, slotContext.entity().getType(), slotContext.entity().isBaby());
*/
			poseStack.popPose();
		}
	}
