...
public class BackpackRecipeViewerDisplays {
	...
	public static void register(IRecipeViewerDisplayCatalog catalog, IRecipeViewerDisplayContext context) {
		...
		ClientRecipeHelper.transformAllRecipeHoldersOfType(RecipeType.CRAFTING, BackpackUpgradeRecipe.class,
				(id, recipeHolder) -> new RecipeHolder<CraftingRecipe>(id, recipeHolder.value()))
