...
public record BackpackSmithingUpgradeDisplayRecipe(ResourceLocation id, RecipeHolder<SmithingRecipe> recipeHolder, Optional<Ingredient> template, Optional<Ingredient> addition,
