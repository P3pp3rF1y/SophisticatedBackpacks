...
public class SmithingBackpackUpgradeRecipeBuilder {
	...
	public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> id) {
		...
		recipeOutput.accept(id, new SmithingBackpackUpgradeRecipe(Optional.of(template), Optional.of(base), Optional.of(addition), new ItemStack(result)),
				advancement$builder.build(id.location().withPrefix("recipes/" + category.getFolderName() + "/")));
	}
