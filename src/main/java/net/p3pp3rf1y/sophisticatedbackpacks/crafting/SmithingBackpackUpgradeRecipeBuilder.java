...
public class SmithingBackpackUpgradeRecipeBuilder {
	...
	public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> id) {
		...
		recipeOutput.accept(id, new SmithingBackpackUpgradeRecipe(new Recipe.CommonInfo(true), Optional.of(template), base, Optional.of(addition),
				new ItemStackTemplate(result)), advancement$builder.build(id.identifier().withPrefix("recipes/" + category.getFolderName() + "/")));
	}
