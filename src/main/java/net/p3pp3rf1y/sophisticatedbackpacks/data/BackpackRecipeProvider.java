...
public class BackpackRecipeProvider extends RecipeProvider {
	...
	private void addCompatUpgradeRecipes(RecipeOutput recipeOutput) {
		if (ModList.get().isLoaded(net.p3pp3rf1y.sophisticatedcore.compat.CompatModIds.CHIPPED)) {
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.BOTANIST_WORKBENCH_UPGRADE.get(), ModBlocks.BOTANIST_WORKBENCH.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.GLASSBLOWER_UPGRADE.get(), ModBlocks.GLASSBLOWER.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.CARPENTERS_TABLE_UPGRADE.get(), ModBlocks.CARPENTERS_TABLE.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.LOOM_TABLE_UPGRADE.get(), ModBlocks.LOOM_TABLE.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.MASON_TABLE_UPGRADE.get(), ModBlocks.MASON_TABLE.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.ALCHEMY_BENCH_UPGRADE.get(), ModBlocks.ALCHEMY_BENCH.get(), CompatModIds.CHIPPED);
			addCompatUpgradeRecipe(recipeOutput, ChippedCompat.TINKERING_TABLE_UPGRADE.get(), ModBlocks.TINKERING_TABLE.get(), CompatModIds.CHIPPED);
