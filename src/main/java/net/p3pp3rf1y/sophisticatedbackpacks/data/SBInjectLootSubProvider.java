...
public class SBInjectLootSubProvider implements LootTableSubProvider {
	...
	public static final ResourceLocation ABANDONED_MINESHAFT = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.ABANDONED_MINESHAFT.getPath());
	public static final ResourceLocation BASTION_TREASURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.BASTION_TREASURE.getPath());
	public static final ResourceLocation DESERT_PYRAMID = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.DESERT_PYRAMID.getPath());
	public static final ResourceLocation END_CITY_TREASURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.END_CITY_TREASURE.getPath());
	public static final ResourceLocation NETHER_BRIDGE = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.NETHER_BRIDGE.getPath());
	public static final ResourceLocation SHIPWRECK_TREASURE = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.SHIPWRECK_TREASURE.getPath());
	public static final ResourceLocation SIMPLE_DUNGEON = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.SIMPLE_DUNGEON.getPath());
	public static final ResourceLocation WOODLAND_MANSION = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.WOODLAND_MANSION.getPath());
	public static final ResourceLocation SPAWN_BONUS_CHEST = new ResourceLocation(SophisticatedBackpacks.MOD_ID,
			INJECT_FOLDER + BuiltInLootTables.SPAWN_BONUS_CHEST.getPath());
	public static final Set<ResourceLocation> ALL_TABLES = Set.of(ABANDONED_MINESHAFT, BASTION_TREASURE, DESERT_PYRAMID, END_CITY_TREASURE, NETHER_BRIDGE,
