...
public class ItemDisplaySettingsTab extends SettingsTab<ItemDisplaySettingsContainer> {
	...
	private static final List<Component> ROTATE_TOOLTIP = new ImmutableList.Builder<Component>()
			.add(new TranslatableComponent(TranslationHelper.translSettingsButton("rotate")))
			.addAll(TranslationHelper.getTranslatedLines(TranslationHelper.translSettingsButton("rotate_detail"), null, ChatFormatting.GRAY))
			.build();
	...
	public ItemDisplaySettingsTab(ItemDisplaySettingsContainer container, Position position, SettingsScreen screen) {
		super(container, position, screen, new TranslatableComponent(translSettings(ItemDisplaySettingsCategory.NAME)),
				new ImmutableList.Builder<Component>()
						.add(new TranslatableComponent(translSettingsTooltip(ItemDisplaySettingsCategory.NAME)))
						.addAll(TranslationHelper.getTranslatedLines(translSettingsTooltip(ItemDisplaySettingsCategory.NAME) + "_detail", null, ChatFormatting.GRAY))
						.build(),
				new ImmutableList.Builder<Component>()
						.add(new TranslatableComponent(translSettingsTooltip(ItemDisplaySettingsCategory.NAME)))
						.addAll(TranslationHelper.getTranslatedLines(translSettingsTooltip(ItemDisplaySettingsCategory.NAME) + "_open_detail", null, ChatFormatting.GRAY))
						.build(),
