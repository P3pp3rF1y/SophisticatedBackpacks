...
public abstract class DepositFilterLogicControl extends FilterLogicControl<DepositFilterLogic, DepositFilterLogicContainer> {
	public static final ButtonDefinition.Toggle<DepositFilterType> DEPOSIT_FILTER_TYPE = ButtonDefinitions
			.createToggleButtonDefinition(Map.of(DepositFilterType.ALLOW,
					GuiHelper.getButtonStateData(
							new UV(0, 0), BackpackTranslationHelper.INSTANCE.translUpgradeButton("allow"), Dimension.SQUARE_16, new Position(1, 1)),
					DepositFilterType.BLOCK,
					GuiHelper.getButtonStateData(new UV(16, 0), BackpackTranslationHelper.INSTANCE.translUpgradeButton("block"), Dimension.SQUARE_16,
							new Position(1, 1)),
					DepositFilterType.INVENTORY, GuiHelper.getButtonStateData(new UV(64, 16),
							BackpackTranslationHelper.INSTANCE.translUpgradeButton("deposit_filter_type_inventory"), Dimension.SQUARE_16, new Position(1, 1))));
