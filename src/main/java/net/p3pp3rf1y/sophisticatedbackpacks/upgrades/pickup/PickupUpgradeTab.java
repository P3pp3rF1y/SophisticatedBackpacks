...
public class PickupUpgradeTab extends UpgradeSettingsTab<FilteredUpgradeContainer<PickupUpgradeWrapper>> {
	protected PickupUpgradeTab(FilteredUpgradeContainer<PickupUpgradeWrapper> upgradeContainer, Position position, Dimension openTabDimension, BackpackScreen screen, int slotsPerRow, ITextComponent tabLabel, ITextComponent closedTooltip) {
