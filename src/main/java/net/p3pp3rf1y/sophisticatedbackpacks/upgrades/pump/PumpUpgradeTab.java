...
public class PumpUpgradeTab extends UpgradeSettingsTab<PumpUpgradeContainer> {
	...
	protected PumpUpgradeTab(PumpUpgradeContainer upgradeContainer, Position position, BackpackScreen screen, ITextComponent tabLabel, ITextComponent closedTooltip) {
