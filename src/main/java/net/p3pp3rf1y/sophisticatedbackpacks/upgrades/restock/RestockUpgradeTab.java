...
public abstract class RestockUpgradeTab extends UpgradeSettingsTab<FilteredUpgradeContainer<RestockUpgradeWrapper>> {
	...
	protected RestockUpgradeTab(FilteredUpgradeContainer<RestockUpgradeWrapper> upgradeContainer, Position position, Dimension openTabDimension, BackpackScreen screen, ITextComponent tabLabel, ITextComponent closedTooltip) {
