...
public abstract class CookingUpgradeTab<R extends AbstractCookingRecipe, W extends CookingUpgradeWrapper<W, ?, R>>
	...
	protected CookingUpgradeTab(CookingUpgradeContainer<R, W> upgradeContainer, Position position, StorageScreen<?> screen, String tabLabel, String closedTooltip) {
	...
	public static class SmeltingUpgradeTab extends CookingUpgradeTab<SmeltingRecipe, CookingUpgradeWrapper.SmeltingUpgradeWrapper> {
		public SmeltingUpgradeTab(CookingUpgradeContainer<SmeltingRecipe, CookingUpgradeWrapper.SmeltingUpgradeWrapper> upgradeContainer, Position position, StorageScreen<?> screen) {
	...
	public static class SmokingUpgradeTab extends CookingUpgradeTab<SmokingRecipe, CookingUpgradeWrapper.SmokingUpgradeWrapper> {
		public SmokingUpgradeTab(CookingUpgradeContainer<SmokingRecipe, CookingUpgradeWrapper.SmokingUpgradeWrapper> upgradeContainer, Position position, StorageScreen<?> screen) {
	...
	public static class BlastingUpgradeTab extends CookingUpgradeTab<BlastingRecipe, CookingUpgradeWrapper.BlastingUpgradeWrapper> {
		public BlastingUpgradeTab(CookingUpgradeContainer<BlastingRecipe, CookingUpgradeWrapper.BlastingUpgradeWrapper> upgradeContainer, Position position, StorageScreen<?> screen) {
