...
public class PumpUpgradeTab extends UpgradeSettingsTab<PumpUpgradeContainer> {
	...
	protected PumpUpgradeTab(PumpUpgradeContainer upgradeContainer, Position position, StorageScreen<?> screen, Component tabLabel, Component closedTooltip) {
	...
	public static class Basic extends PumpUpgradeTab {
		public Basic(PumpUpgradeContainer upgradeContainer, Position position, StorageScreen<?> screen) {
	...
	public static class Advanced extends PumpUpgradeTab {
		public Advanced(PumpUpgradeContainer upgradeContainer, Position position, StorageScreen<?> screen) {
