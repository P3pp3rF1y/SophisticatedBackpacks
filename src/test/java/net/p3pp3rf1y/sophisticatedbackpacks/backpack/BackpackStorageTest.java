...
class BackpackStorageTest {
	...
	void legacyBackpackStorageKeepsEnchantedItems() {
		UUID backpackUuid = new UUID(1, 2);
		CompoundTag legacyStorage = new CompoundTag();
		legacyStorage.put("accessLogRecords", new ListTag());
		legacyStorage.put("backpackContents", enchantedLegacyBackpackContents(backpackUuid));
	...
	private static ListTag enchantedLegacyBackpackContents(UUID backpackUuid) {
		...
		uuidContentsPair.put("contents", enchantedContents());
