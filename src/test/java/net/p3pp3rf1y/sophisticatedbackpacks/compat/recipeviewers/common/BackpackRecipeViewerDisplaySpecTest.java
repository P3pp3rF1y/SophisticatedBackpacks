...
class BackpackRecipeViewerDisplaySpecTest {
	...
	void smithingSyntheticRecipeHolderUsesFocusedBaseAndResult() {
		...
		assertSameStack(tintedNetheriteBackpack, recipeHolder.value().assemble(new SmithingRecipeInput(ItemStack.EMPTY, tintedStack(ModItems.DIAMOND_BACKPACK.get()), ItemStack.EMPTY), null));
	}
